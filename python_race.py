...
def update_plot(num):
    ...
    return plane1_trajectory,plane1_1,plane1_2,plane1_3,plane1_4,plane1_5,\
        x_dist1,speed1,plane2_trajectory,plane2_1,plane2_2,plane2_3,plane2_4,plane2_5,\
        x_dist2,speed2,plane3_trajectory,plane3_1,plane3_2,plane3_3,plane3_4,plane3_5,\
        x_dist3,speed3,
